      ...
      >
        {isLoading ? (
          ...
          >
            ...
            />
            <p className="text-lg font-bold text-left mt-4">Email:</p>
            <input
              type="email"
              name="email"
              onBlur={handleOnBlur}
              ...
              className="border-gray-400 border-2 p-1 rounded w-full"
            />
            <p className="text-lg font-bold text-left mt-4">Password:</p>
            <input
              type="password"
              name="password"
              onBlur={handleOnBlur}
            ...
            <p className="text-gray-500 mt-8 text-sm">Or login with</p>
            <img
              className="w-9 mx-auto mt-8 mb-5 cursor-pointer"
              onClick={() => loginUsingGoogle(location, navigate)}
